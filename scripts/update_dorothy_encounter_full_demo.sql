-- Update Dorothy Robinson's encounter with complete demo data
-- This replaces the basic data with the full diabetes/warfarin interaction case
...
• New glucometer and diabetes education before discharge',
    ...
    RAISE NOTICE 'Successfully updated encounter % with complete demo data', v_encounter_uuid;
  ELSE
    RAISE NOTICE 'Encounter not found';
  END IF;
