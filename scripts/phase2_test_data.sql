...
-- Test Patient 1: Diabetes patient with follow-up visit
...
BEGIN
  ...
  VALUES 
    (patient_uuid, visit_uuid, 'Hemoglobin A1C', '8.2', '%', NOW() - INTERVAL '1 week', '4.0-5.6', 'H'),
    (patient_uuid, visit_uuid, 'Glucose', '185', 'mg/dL', NOW() - INTERVAL '1 week', '70-100', 'H'),
    (patient_uuid, visit_uuid, 'Creatinine', '1.1', 'mg/dL', NOW() - INTERVAL '1 week', '0.7-1.3', NULL)
  ON CONFLICT DO NOTHING;
END $$;
...
BEGIN
  ...
  INSERT INTO public.lab_results(patient_id, encounter_id, name, value, units, date_time, reference_range, flag)
  VALUES 
    (patient_uuid, visit_uuid, 'ESR', '45', 'mm/hr', NOW() - INTERVAL '2 days', '0-20', 'H'),
    (patient_uuid, visit_uuid, 'CRP', '3.2', 'mg/dL', NOW() - INTERVAL '2 days', '0-1.0', 'H'),
    (patient_uuid, visit_uuid, 'RF', '82', 'IU/mL', NOW() - INTERVAL '2 days', '0-14', 'H')
  ON CONFLICT DO NOTHING;
END $$;
...
BEGIN
  ...
  INSERT INTO public.lab_results(patient_id, encounter_id, name, value, units, date_time, reference_range, flag)
  VALUES 
    (patient_uuid, visit_uuid, 'WBC', '12.5', 'K/uL', NOW() - INTERVAL '1 hour', '4.5-11.0', 'H'),
    (patient_uuid, visit_uuid, 'Temperature', '101.2', 'F', NOW() - INTERVAL '30 minutes', '97.0-99.0', 'H')
  ON CONFLICT DO NOTHING;
END $$;
...
BEGIN
  ...
  INSERT INTO public.lab_results(patient_id, encounter_id, name, value, units, date_time, reference_range, flag)
  VALUES 
    (patient_uuid, visit_uuid, 'Troponin I', '0.02', 'ng/mL', NOW() - INTERVAL '2 hours', '0-0.04', NULL),
    (patient_uuid, visit_uuid, 'Total Cholesterol', '245', 'mg/dL', NOW() - INTERVAL '1 month', '0-200', 'H'),
    (patient_uuid, visit_uuid, 'LDL', '165', 'mg/dL', NOW() - INTERVAL '1 month', '0-100', 'H')
  ON CONFLICT DO NOTHING;
END $$;
...
LEFT JOIN public.visits v ON v.patient_supabase_id = p.id
