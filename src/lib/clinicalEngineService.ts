...
class ClinicalEngineService {
  ...
  async generateDiagnosticResult(
    ...
    try {
      ...
      // Fallback to mock data if API call fails, for development purposes
      // symptoms and plan are passed to allow mock to function as before if needed for direct call
      return this.getMockDiagnosticResult(symptoms || [], plan); 
    }
  }
