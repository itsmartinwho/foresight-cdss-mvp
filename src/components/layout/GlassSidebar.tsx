...
export default function GlassSidebar() {
  ...
  return (
    <div className={`min-h-[calc(100svh-4rem)] ${collapsed ? 'w-[4.5rem]' : 'w-56'} backdrop-blur-sm bg-transparent border-r border-[rgba(255,255,255,0.084)] flex flex-col pt-6 pb-3 px-3 hidden lg:flex transition-all duration-300 ease-in-out overflow-hidden`}>
