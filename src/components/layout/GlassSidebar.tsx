...
export default function GlassSidebar() {
  ...
  return (
    <div className={`h-full ${collapsed ? 'w-[4.5rem]' : 'w-56'} bg-glass backdrop-blur-lg border-r border-[rgba(255,255,255,0.12)] shadow-card flex flex-col p-3 hidden lg:flex rounded-tr-card rounded-br-none relative transition-all duration-300 ease-in-out overflow-hidden`}>
