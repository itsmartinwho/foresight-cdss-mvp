...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative z-10 overflow-hidden isolate",
  {
    variants: {
      variant: {
        default:
          "relative isolate border border-transparent text-white before:absolute before:-inset-[1px] before:-z-10 before:rounded-md before:bg-[conic-gradient(from_180deg_at_50%_50%,hsl(var(--accent-primary)),hsl(var(--accent-secondary)),hsl(var(--accent-tertiary)),hsl(var(--accent-primary)))] before:bg-[length:200%_200%] before:opacity-90 before:transition-transform before:duration-\[0ms\] hover:before:animate-conic-spin focus-visible:ring-neon",
        destructive:
        ...
        teal: "bg-foresight-teal text-white shadow-sm hover:bg-foresight-teal-darker"
      },
      size: {
