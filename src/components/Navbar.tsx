        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:block">
            <Input
              type="text"
              placeholder="Search…"
              className="unified-search-input h-8 w-64 bg-[rgba(255,255,255,0.06)] backdrop-blur-sm text-step-0 focus-visible:ring-2 focus-visible:ring-[rgba(95,243,255,0.4)] focus:outline-none rounded-full px-3"
            />
          </div>
          <button
