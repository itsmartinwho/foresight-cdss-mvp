  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <p className="text-gray-600 mb-8">
        This demonstrates how clinical guideline references appear in advisor responses with source badges and visual indicators.
      </p>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <GuidelineReferences references={mockGuidelineReferences} />
      </div>
    </div>
  );
} 